...
import net.v4lproik.googlanime.platform.client.elasticsearch.ConfigES;
...
public class WebsiteControllerUTest {
    ...
    public void testGetAnimeFromMALWithNoDependency_withData_shouldReturnAnime() throws Exception {
        ...
        when(crawlerRegistry.crawl(20, TypeEnum.fromValue(type), SourceEnum.fromValue(from))).thenReturn(anime);
