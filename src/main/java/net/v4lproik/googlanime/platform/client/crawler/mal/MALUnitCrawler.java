package net.v4lproik.googlanime.platform.client.crawler.mal;
...
import net.v4lproik.googlanime.platform.client.crawler.AbstractUnitCrawler;
...
import net.v4lproik.googlanime.platform.service.api.utils.TransformAnimeMapper;
