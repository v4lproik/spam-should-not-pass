...
curl -X POST -H "x-auth-token: $token" -H "Content-type: application/json" -H "Accept: application/json" -d "{\"java.lang.String\":\"userId\", \"java.lang.String\":\"firstname\"}" http://localhost:8080/spammer/create-spammer-document
